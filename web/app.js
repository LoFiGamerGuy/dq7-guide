...
function renderRichDetail(detail, summary) {
  ...
  if (state.domain === "items") {
    ...
    const plan = detail.unlock_progress || {}, groups = plan.groups || [], partyProgress = plan.party_progress || [];
