...
| Phone access | Private persistent pairing URL; normal restart preserves bookmark; explicit rotation revokes it; paired API responses are network-only and never cached | Ready on trusted LAN |
