...
Current reproducible headline counts are 291 sources, 353 items with 488 acquisition paths, 333 monsters with 225 checkpoint-gated encounters and 137 verified drops, all 46 Monster Heart identities/effects, 100 Mini Medals, 71 tablet fragments, 61 achievements, and 26 complete vocation skill/perk ladders. `INGEST_STATUS.md` remains the authoritative detailed ledger.
