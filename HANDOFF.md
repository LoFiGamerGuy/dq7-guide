...
the 10 explicit `container_unspecified` rows summarized above. Direct English
...
several individual containers; the current residual is the 10-row set summarized
...
subsequent direct evidence reduced the current total to 10.
