...
Current reproducible headline counts are 331 sources, 353 items with 611 acquisition paths, 333 monsters with 300 checkpoint-gated encounters and 161 verified drops, all 46 Monster Heart identities/effects with linked acquisition routes for 40, 18 fixed Seed effects and one repeatable reward rule, 9 checkpoint-gated farms with separate fact/strategy provenance, 7 sourced missable records (5 exact and 2 unresolved cutoffs), 14 Lucky Panel pools with 201 rewards, 100 Mini Medals, 71 tablet fragments, 61 achievements, and 26 complete vocation skill/perk ladders. All 33 walkthrough checkpoints have direct RPG Site section-range locators; their `seed_partial` status remains because provenance completeness does not mean the guide content and optimization layers are complete. The browser includes a searchable source/freshness registry and symmetric conflict evidence. `INGEST_STATUS.md` remains the authoritative detailed ledger.
