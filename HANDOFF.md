...
Combat/optimization handoff: 110 checkpoint advice rows cover every checkpoint except the non-combat ending victory lap, 10 farming routes have exact gates, all 26 vocation skill/perk ladders and qualitative non-default modifiers are normalized, and 312/333 monsters have at least one gated encounter. Safe next work is limited to new direct current-version boss tactics or better finite gear routes. Do not fill the present evidence blocks by inference: numeric vocation modifiers/mastery costs, numeric farming or drop rates, repeatable Heart farming, complete equipability/slot rules, Moonlighting venue/legal-pair restrictions, and the 21 categorized unrouted monsters in `INGEST_STATUS.md`.
