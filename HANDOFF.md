...
Current reproducible headline counts are 348 sources, 353 items with 692 acquisition paths, 333 monsters with 317 checkpoint-gated encounters and 175 verified drops, all 46 Monster Heart identities/effects with linked acquisition routes for 40, 18 fixed Seed effects and one repeatable reward rule, 10 checkpoint-gated farms with separate fact/strategy provenance, 7 sourced missable records (6 exact and 1 unresolved cutoff), 14 Lucky Panel pools with 282 rewards, 100 Mini Medals, 71 tablet fragments, 61 achievements, and 26 complete vocation skill/perk ladders. All directly published Lucky Panel standard-rank matrices are normalized with exact-name gaps retained. All 33 walkthrough checkpoints have direct RPG Site section-range locators; their `seed_partial` status remains because provenance completeness does not mean the guide content and optimization layers are complete. The browser includes a searchable source/freshness registry and symmetric conflict evidence. `INGEST_STATUS.md` remains the authoritative detailed ledger.
