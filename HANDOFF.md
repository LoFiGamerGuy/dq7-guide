...
Current reproducible headline counts are 396 sources, 355 shared items (353 in the registered Heroic Hoarder matrix) with 722 acquisition paths, 333 monsters with 373 checkpoint-gated encounters and 210 verified drops, all 46 Monster Heart identities/effects with linked acquisition routes for 41, 18 fixed Seed effects and one repeatable reward rule, 10 checkpoint-gated farms with separate fact/strategy provenance, 7 sourced missable records (6 exact and 1 unresolved cutoff), 14 Lucky Panel pools with 291 rewards, 100 Mini Medals, 71 tablet fragments, 61 achievements, and 26 complete vocation skill/perk ladders. Meowgician Heart now has a direct finite Vicious Meowgician route at cp005; among the five remaining unlinked Hearts, Metal Slime and Gold Golem have explicit DLC notes while Dragonlord, Malroth, and Zoma availability remains unknown. Dedicated current-version pages resolve Knuckledusters and three spelling/number variants without changing the 353-item Heroic matrix. Direct evidence now adds finite free alternatives through cp015, including Divine Dagger, Scale Armour, Strength Ring, Knuckledusters, Iron Lance, and Yggdrasil Leaf, while retaining unknown exact containers. All directly published Lucky Panel standard-rank matrices are normalized with remaining exact-name gaps retained. All 33 walkthrough checkpoints have direct RPG Site section-range locators; their `seed_partial` status remains because provenance completeness does not mean the guide content and optimization layers are complete. The browser includes a searchable source/freshness registry and symmetric conflict evidence. `INGEST_STATUS.md` remains the authoritative detailed ledger.
