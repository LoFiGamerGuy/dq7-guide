...
Current reproducible headline counts are 316 sources, 353 items with 501 acquisition paths, 333 monsters with 273 checkpoint-gated encounters and 149 verified drops, all 46 Monster Heart identities/effects, 18 fixed Seed effects and one repeatable reward rule, 8 checkpoint-gated farms with separate fact/strategy provenance, 7 sourced missable records (5 exact and 2 unresolved cutoffs), 14 Lucky Panel pools with 91 rewards, 100 Mini Medals, 71 tablet fragments, 61 achievements, and 26 complete vocation skill/perk ladders. The first 20 walkthrough checkpoints have direct section-range locators; the remaining 13 are explicitly queued for verification. The browser includes a searchable source/freshness registry and symmetric conflict evidence. `INGEST_STATUS.md` remains the authoritative detailed ledger.
