...
class MobileUiContractTests(unittest.TestCase):
    ...
    def test_phone_companion_controls_and_safe_area_support_are_present(self):
        ...
        self.assertIn('corroborated_but_unresolved: `${gap.publisher_count} publishers · still unresolved`', js)
        self.assertIn('single_source: `${gap.publisher_count} publisher`', js)
        ...
        self.assertIn(".evidence-claim a, .evidence-claim small { overflow-wrap: anywhere; }", css)
