...
class GuideServerTests(unittest.TestCase):
    ...
    def test_phone_shell_manifest_service_worker_and_backup(self):
        ...
        with urlopen(self.base + "/service-worker.js") as response:
            ...
            self.assertIn(b'dq7-guide-shell-v6', worker)
            self.assertIn(b'dq7-guide-data-v6', worker)
            self.assertNotIn(b'dq7-guide-shell-v5', worker)
            self.assertNotIn(b'dq7-guide-data-v5', worker)
