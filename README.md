...
- a 704-page source registry with browser search and retrieval-freshness metadata;
...
Direct current-version English gameplay now identifies the individual postgame
