...
- **Items:** the priority finite-container video queue is resolved, but 26 acquisition rows still deliberately carry `container_unspecified`: 21 broad area/reward-style `other` routes and five chest routes. These are not silently counted as exact containers; they require semantic reclassification or direct member-level evidence. Direct English item-result footage resolves Dragon Shield, Pirate's Hat, Silk Robe, Steel Helmet, and Knuckledusters to individual containers. A current-version PS5 video with Italian UI resolves Faraday Strength Ring to the lower/southern east-wall bedroom drawer, with Single Phial in the adjacent upper/northern drawer; the English localization is not inferred. Present Poolside Cave Fur Cape is resolved to the lone chest in the B2 section-1 northeast terminal alcove; Coagulant is corrected from Hubble Castle to the lower-roof barrel of Hubble Past's western Inquisitory. NightlyGamingBinge's current-version Heart guide resolves Little Devil Heart to the chest on Burnmount Level 2's exterior mountain ledge and Healslime Heart to a Grotta del Sigillo Level 2 chest. The three formerly untyped shop-like rows have direct prices and typed shop inventory records.
