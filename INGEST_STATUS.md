...
|---|---:|---|---|
| Source registry | 324 high-value pages | High metadata / mixed page freshness | Add official and in-game evidence sources |
...
| Heroic Hoarder items | 353/353 identities / 547 acquisition paths; all items have routes; 44 direct monster-drop alternatives normalized for 19 items previously represented only by Lucky Panel routes | High for identities and explicit routes; Stella/Stellar spelling conflict remains visible | Expand remaining alternate free routes and finite-supply evidence |
| Lucky Panel | 14 normalized pools / 137 reward paths; Version 2 and Version 3 treasure-chest matrices complete; Version 3 Rank 1/2 safely link 22/25 and 32/36 published names | High for normalized rows; entry costs and reward probabilities remain unknown | Resolve remaining source-to-registry name gaps, then complete Version 3 Rank 3/4 and earlier matrices |
...
| Monster List / Vicious | 333/333 ordinals and English names; 292 gated locations across 191 monsters and 153 drops across 134 monsters; 10 Vicious species / 11 encounters | High for normalized rows | Continue remaining encounter and drop ingestion |
...
- monsters: 333
- monster encounters / drops: 292 / 153
...
- item aliases / acquisition paths: 1 / 547
- shops / inventory rows: 47 / 115
- Lucky Panel pools / reward rows: 14 / 137
...
The current monster expansion has 292 checkpoint-gated encounter routes across 191 of 333 monsters and 153 verified drop rows across 134 monsters. The latest early-gap batch adds The Automatrist at cp007, Metal Slime as a bonus encounter at cp008, and Rashers plus Stripes at cp009. Their direct pages publish no attributable drops; the scripted-loss first Rashers/Stripes encounter and Metal Slime's non-overworld bonus-spawn behavior remain explicit.
