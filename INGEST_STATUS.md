...
| Equipment | 110 ready-for-play advice rows; two accessory mechanics corroborated; 237 canonical weapon/shield/head/torso compatibility rows audited, with 119 two-source agreements, 116 disagreements, and 2 single-source rows | Verified for the 119 agreeing rows; disputed and single-source rows are not normalized | Resolve the 116 row disagreements, accessory compatibility, and duplicate behavior before enabling writes |
