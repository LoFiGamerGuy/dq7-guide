...
| Equipment | 110 ready-for-play advice rows; two accessory mechanics corroborated; 237 canonical weapon/shield/head/torso rows audited against three catalogs, with 230 two-publisher agreements, 5 three-way disagreements, and 2 single-source rows | Verified for the 230 agreeing rows; disputed and single-source rows are not normalized | Resolve the 5 row disagreements, accessory compatibility, and duplicate behavior before enabling writes |
