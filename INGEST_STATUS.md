...
The phone cache namespace advances to v7 with the collapsed evidence-gap cards. Activation removes old shell/data caches and the existing one-time controller-change reload installs the new assets; paired authenticated API responses remain network-only.
