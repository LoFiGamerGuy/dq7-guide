...
|---|---:|---|---|
| Source registry | 41 high-value pages | High metadata / mixed page freshness | Add official and in-game evidence sources |
...
| Conflicts | Automatic exact-scope detection active; 4 unresolved source conflicts | Conservative coverage | Resolve Medal 78, Cautery Sword, Elevating Shoes, and Iron Shield with direct in-game evidence |
