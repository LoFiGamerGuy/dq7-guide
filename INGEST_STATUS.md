...
The phone cache namespace advances from v5 to v6 with the ledger-navigation shell. Activation removes old shell/data caches and the existing one-time controller-change reload installs the new assets; paired authenticated API responses remain network-only.
