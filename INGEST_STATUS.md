...
Four grouped rows retain useful room-level refinement without an individual member mapping: Temple Palace hidden-room Gold Bracer, Another World Level 3 jail-cell Day Off Dress, Hubble Castle NW Tower dresser-pair Silk Tuxedo, and Faraday Castle throne-bedroom Ruby of Protection. Their `container_unspecified` status remains intentional.
